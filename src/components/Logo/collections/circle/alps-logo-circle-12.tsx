...
const AlpsLogoCircle12: FC<AlpsLogoCircleProps> = ({
  width = "auto",
  height = "auto",
  style,
}) => (
  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={width} height={height} viewBox="0 0 512 512" style={style}>
    ...
    <g id="Group_151" data-name="Group 151" transform="translate(-1092 -3226)">
      <path id="Path_72" data-name="Path 72" d="M256,0C397.385,0,512,114.615,512,256S397.385,512,256,512,0,397.385,0,256,114.615,0,256,0Z" transform="translate(1092 3226)" fill="#3e4267" />
...
export default AlpsLogoCircle12;