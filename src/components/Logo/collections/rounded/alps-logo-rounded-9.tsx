...
const AlpsLogoRounded9: FC<AlpsLogoRoundedProps> = ({
  width = "auto",
  height = "auto",
  style,
}) => (
  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={width} height={height} viewBox="0 0 512 512" style={style}>
    ...
    <g id="Group_122" data-name="Group 122" transform="translate(-1092 -3226)">
      <rect id="Rectangle_160" data-name="Rectangle 160" width="512" height="512" rx="100" transform="translate(1092 3226)" fill="#3e4267" />
...
export default AlpsLogoRounded9